  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      <VStack style={{paddingRight: 10, paddingLeft: 5}}>
        ...
        <Text>
          4. Oyunculardan biri "X" ile başlar, diğer oyuncu "O" ile yanıt verir.
        </Text>
        <Text>
        ...
        <Text>
          8. Bir oyuncu, aynı sembollerle üçünü yatay, dikey veya çapraz olarak
          birleştirdiğinde, o oyuncu oyunu kazanır.
        </Text>
        <Text>
          9. Kazanan oyuncu, kazandığı hizalamanın üzerine çizer veya sembolünü
          yerleştirir.
        </Text>
        <Text>
        ...
        <Text>12. Oyun kazanana kadar veya tahta dolana kadar devam eder.</Text>
        <Text>
